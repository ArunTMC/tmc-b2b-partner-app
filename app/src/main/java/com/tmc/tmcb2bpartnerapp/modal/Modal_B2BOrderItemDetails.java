...
public class Modal_B2BOrderItemDetails {
    ...
    public  String orderid ="",retailermobileno ="",retailerkey = "" , b2bctgykey ="" , b2bsubctgykey ="",orderplaceddate ="",b2bctgyName="",b2bSubctgyName ="",
            ...
            partsweight ="", meatyieldweight ="",approxliveweight ="",deliverycenterkey ="",itemPrice ="",totalPrice_ofItem ="",discount ="0",totalItemWeight ="";

    public  boolean isItemAlreadyMarkedDelivered = false , isItemNowMarkedforDelivered = false;
    public String dicountweightageAmount = "0" , dicountweightageAmountPercentage = "0" ;
    ...
    partsweight_static ="", meatyieldweight_static ="",approxliveweight_static ="",deliverycenterkey_static ="",itemPrice_static ="",totalPrice_ofItem_static ="",discount_static ="0",totalItemWeight_static ="";
    public static  String dicountweightageAmount_static = "0" , dicountweightageAmountPercentage_static = "0" ;

    public static boolean isItemAlreadyMarkedDelivered_static = false , isItemNowMarkedforDelivered_static = false;
    ...
    public boolean isItemAlreadyMarkedDelivered() {
        return isItemAlreadyMarkedDelivered;
    }

    public void setItemAlreadyMarkedDelivered(boolean itemAlreadyMarkedDelivered) {
        isItemAlreadyMarkedDelivered = itemAlreadyMarkedDelivered;
    }

    public boolean isItemNowMarkedforDelivered() {
        return isItemNowMarkedforDelivered;
    }

    public void setItemNowMarkedforDelivered(boolean itemNowMarkedforDelivered) {
        isItemNowMarkedforDelivered = itemNowMarkedforDelivered;
    }
    ...
    public static String getPartsweight_static() {
        return partsweight_static;
    }

    public static void setPartsweight_static(String partsweight_static) {
        Modal_B2BOrderItemDetails.partsweight_static = partsweight_static;
    }

    public static String getMeatyieldweight_static() {
        return meatyieldweight_static;
    }

    public static void setMeatyieldweight_static(String meatyieldweight_static) {
        Modal_B2BOrderItemDetails.meatyieldweight_static = meatyieldweight_static;
    }

    public static String getApproxliveweight_static() {
        return approxliveweight_static;
    }

    public static void setApproxliveweight_static(String approxliveweight_static) {
        Modal_B2BOrderItemDetails.approxliveweight_static = approxliveweight_static;
    }

    public static String getDeliverycenterkey_static() {
        return deliverycenterkey_static;
    }

    public static void setDeliverycenterkey_static(String deliverycenterkey_static) {
        Modal_B2BOrderItemDetails.deliverycenterkey_static = deliverycenterkey_static;
    }

    public static String getItemPrice_static() {
        return itemPrice_static;
    }

    public static void setItemPrice_static(String itemPrice_static) {
        Modal_B2BOrderItemDetails.itemPrice_static = itemPrice_static;
    }

    public static String getTotalPrice_ofItem_static() {
        return totalPrice_ofItem_static;
    }

    public static void setTotalPrice_ofItem_static(String totalPrice_ofItem_static) {
        Modal_B2BOrderItemDetails.totalPrice_ofItem_static = totalPrice_ofItem_static;
    }

    public static String getDiscount_static() {
        return discount_static;
    }

    public static void setDiscount_static(String discount_static) {
        Modal_B2BOrderItemDetails.discount_static = discount_static;
    }

    public static String getTotalItemWeight_static() {
        return totalItemWeight_static;
    }

    public static void setTotalItemWeight_static(String totalItemWeight_static) {
        Modal_B2BOrderItemDetails.totalItemWeight_static = totalItemWeight_static;
    }


    public static boolean isIsItemAlreadyMarkedDelivered_static() {
        return isItemAlreadyMarkedDelivered_static;
    }

    public static void setIsItemAlreadyMarkedDelivered_static(boolean isItemAlreadyMarkedDelivered_static) {
        Modal_B2BOrderItemDetails.isItemAlreadyMarkedDelivered_static = isItemAlreadyMarkedDelivered_static;
    }

    public static boolean isIsItemNowMarkedforDelivered_static() {
        return isItemNowMarkedforDelivered_static;
    }

    public static void setIsItemNowMarkedforDelivered_static(boolean isItemNowMarkedforDelivered_static) {
        Modal_B2BOrderItemDetails.isItemNowMarkedforDelivered_static = isItemNowMarkedforDelivered_static;
    }


    public void setDicountweightageAmount_static(String dicountweightageAmount_static) {
        this.dicountweightageAmount_static = dicountweightageAmount_static;
    }

    public void setDicountweightageAmountPercentage_static(String dicountweightageAmountPercentage_static) {
        this.dicountweightageAmountPercentage_static = dicountweightageAmountPercentage_static;
    }
}
