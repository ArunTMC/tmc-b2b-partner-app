...
public class Modal_B2BOrderDetails {

   public String deliverycentrekey ="" , deliverycentrename ="" , orderid ="" , orderplaceddate = "" , status = "", payableAmount ="",
    priceperkg ="" , discountamount ="", batchno ="", b2bctgykey="" , totalweight= "" , totalquantity ="", totalmalequantity ="",invoiceno ="", paymentmode ="",ordercanceledtime ="",
    totalmaleweight ="",totalfemaleweight = "" , totalfemalewithbabyquantity = "" , totalfemalewithbabyweight ="" ,totalfemalequantity ="",retailerkey ="" , retailermobileno = "", retailername = "";


    public static String deliverycentrekey_Static ="" , deliverycentrename_Static ="" , orderid_Static ="" , orderplaceddate_Static = "" , status_Static = "", payableAmount_Static ="",
            ...
            retailerkey_Static ="" , retailermobileno_Static = "", retailername_Static = "",invoiceno_Static ="",paymentMode_Static="";
